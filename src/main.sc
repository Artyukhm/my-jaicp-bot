...
theme: /
    ...
    state: Start
        ...
        a: Здравствуйте! Я – Наталья, виртуальный ассистент кинотеатра «Киносфера». Я могу оказать техническую поддержку нашим клиентам. Что вас интересует?
        buttons:
...
# стейты для  диалоговых ситуаций
    ...
    state: Сайт
        ...
        q!: *{[(случилось/произошло)] * (с/на) * сайт*}*
    ...
    state: Билет    
        ...
        state:
            q: *{[*не*] (приш*/получ*/отправ*/присла*/восстан*/*тер*) [(билет*/его)]}*
        ...
        state:
            ...
            a: Поняла вас, номер вашего билета по неясной причине оказался недействительным. В этом случае необходима помощь оператора.
            go!: /Оператор
        
            
    state: Личный кабинет
        q!: *{[(надо/нужно/не могу/не получается/не заходит/не работает)] * [*йти/*регистр*] [в/на] * (личн* кабинет*/аккаунт*/учет* [запис*])}*
        q!: *{[возник*/появил*/есть] * (проблем*/ошибк*/сбой) * [с] * (личн* кабинет*/аккаунт*/учет* [запис*])}*
        q!: *{[надо/нужно/не могу/не получается/как] *рег*}*
        q!: *{что [(случилось/произошло)] * [c] * (личн* кабинет*/аккаунт*/учет* [запис*])}*
        q!: *{*доступ* [в] (личн* кабинет*/аккаунт*)}* 
        q!: *{взлом* [(личн* кабинет*/аккаунт*/меня/учет* [запис*])]}*
        q!: *{[(восст*/забыл*/не помн*/*тер*/узнать)] пароль}*
        ...
        state:
            q: *{взлом*[(личн* кабинет*/аккаунт*)/учет* [запис*]]}*
        ...
        state:
            q: *{[(надо/нужно/не могу/не получается/не заходит/не работает/ошибк*)] * [*йти/*рег*] [в/на] * [(личн* кабинет*/аккаунт*/учет* [запис*])]}*
            q: *{[возник*/появил*/есть] (проблем*/ошибк*/сбой) * [с] * (личн* кабинет*/аккаунт*/учет* [запис*])}*
            q: *{*доступ* [в] (личн* кабинет*/аккаунт*)}* 
